...
n=40 #n is the Number of years of analysis
water_saving=50.1   #WS is the Volume of water saved (usage) 
inflamation=0.042 #r is the Inflation rate
...
accessory_cost=600+70  #Accessories cost
...
payback_period=0 #Payback period
levelized_cost=0 #levelized cost
...
########(#############LC measurement####################################
FVwp=(water_price)*(1+inflamation)**n
print(FVwp)
...
for i in range(0,n+1):
     ...
     if CER<=1: break
print(mylst)
print("Payback period is:",payback_period)
NPVeffect=b
print("NPVeffect:",NPVeffect)
levelized_cost=(NPVcost)/ (water_saving*payback_period)
print("Levelized cost of water tank:",levelized_cost,"$/kL")