...
##################################################################
PvModuleName='United Renewable Energy Co. Ltd. FBM535M8G'                                            # You can choose a PV system from the dartabase by name
InverterName='Altenergy Power System Inc : QS1200 [240V]' 
...
print(time)
cursor = connection.cursor()
postgres_insert_query ="""INSERT INTO pvsys_singlediod (i_sc, v_oc, i_mp, v_mp, p_mp,ac_power,dc_power,date,time) VALUES(%s, %s, %s, %s, %s, %s, %s,%s,%s)"""
